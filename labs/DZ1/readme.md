...
```
Консольное подключение используется для первоначальной настройки ip-адреса. Первоначальное подключение по Telnet или SSH невозможно, 
т.к.  ip-адрес неизвестен или не настроен.
```
