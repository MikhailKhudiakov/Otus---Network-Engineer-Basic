...
```
Соединение SSH с коммутатором было установлено.
```
...
```
По умолчанию SSH поддерживает обе версии 1 и 2.
...
```
Для доступа нескольких пользователей необходимо создать несколько пар имен ролбзователя и паролей с помощью команд username и secret.
```
