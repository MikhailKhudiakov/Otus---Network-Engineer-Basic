####  Домашние задания.
 ...
 - [5.Доступ к сетевым устройствам по протоколу SSH](https://github.com/MikhailKhudiakov/Otus---Network-Engineer-Basic/blob/main/labs/DZ5/Readme.md).
 - [6.Внедрение маршрутизации между виртуальными локальными сетями](https://github.com/MikhailKhudiakov/Otus---Network-Engineer-Basic/blob/main/labs/DZ6/Readme.md).
 - [7.Развертывание коммутируемой сети с резервными каналами](https://github.com/MikhailKhudiakov/Otus---Network-Engineer-Basic/blob/main/labs/DZ7/Readme.md).
