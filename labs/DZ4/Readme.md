...
```
Область использования локального адреса ограничена одним каналом, глобальная маршрутизация по этому адресу 
не может быть выполнена, поэтому одинаковый локальный адрес может быть присвоен всем интерфейсам маршрутизатора.
```
